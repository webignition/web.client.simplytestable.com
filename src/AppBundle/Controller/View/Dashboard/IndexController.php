...
namespace AppBundle\Controller\View\Dashboard;

use AppBundle\Controller\BaseViewController;
use AppBundle\Services\CacheValidatorService;
use AppBundle\Services\Configuration\CssValidationTestConfiguration;
use AppBundle\Services\DefaultViewParameters;
use AppBundle\Services\FlashBagValues;
use AppBundle\Services\Configuration\JsStaticAnalysisTestConfiguration;
use AppBundle\Services\SystemUserService;
use AppBundle\Services\TaskTypeService;
use AppBundle\Services\TestOptions\RequestAdapter as TestOptionsRequestAdapter;
