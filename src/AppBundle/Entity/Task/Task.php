...
class Task
{
     ...
     * @var TimePeriod
     *
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\TimePeriod", cascade={"persist"})
     */
    private $timePeriod;
     ...
     * @var TaskOutput
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Task\Output")
     */
    private $output;
     ...
     * @var Test
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Test\Test", inversedBy="tasks")
