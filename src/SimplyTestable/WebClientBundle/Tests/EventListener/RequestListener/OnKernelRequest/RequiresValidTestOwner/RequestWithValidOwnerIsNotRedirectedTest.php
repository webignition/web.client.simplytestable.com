...
namespace SimplyTestable\WebClientBundle\Tests\EventListener\RequestListener\OnKernelRequest\RequiresValidTestOwner;

class RequestWithValidOwnerIsNotRedirectedTest extends RequiresValidTestOwnerTest {
