...
namespace SimplyTestable\WebClientBundle\Tests\Functional\EventListener\RequestListener\OnKernelRequest\RequiresCompletedTest;

class RequestForFailedNoSitemapTestIsRedirectedTest extends RequestIsRedirectedTest {
