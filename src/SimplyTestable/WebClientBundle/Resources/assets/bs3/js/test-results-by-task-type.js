$(document).ready(function() {
    ...
    $('.by-error-list li.error').each(function () {
        ...
        $('.occurrences-container', firstRow).html('<p class="sort-control unsorted link" data-sort-by="occurrences" data-sort-by-type="number" data-sort-by-comparator-pattern="[0-9]" data-sort-by-secondary="url">Sort by occurrences <i class="fa fa-caret-down"></i></p>');
