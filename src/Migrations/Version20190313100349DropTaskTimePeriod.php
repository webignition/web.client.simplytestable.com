 ...
 */
final class Version20190313100349DropTaskTimePeriod extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Task DROP timePeriod_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Task ADD timePeriod_id INT DEFAULT NULL');
