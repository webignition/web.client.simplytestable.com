...
namespace App\Controller\View\Test\Partial\Notification;
...
class UrlLimitController extends AbstractBaseViewController implements RequiresValidUser, RequiresValidOwner
{
    /**
     * @var TestService
     */
